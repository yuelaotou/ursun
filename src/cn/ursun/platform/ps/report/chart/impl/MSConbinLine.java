/**
 * 文件名：MSConbinLineBS.java
 *
 * 创建人：【周洋】 - 【zhouyang@neusoft.com】
 *
 * 创建时间：Dec 15, 2009 9:05:33 PM
 *
 * 版权所有：东软软件股份有限公司
 */
 ...
 * @version 1.0
 */
public class MSConbinLine extends Chart {
	...
	public String getDataConversion()throws BizException{
		...
		root.addAttribute("outCnvBaseFontColor", "666666");
		...
		root.addAttribute("showAlternateVGridColor", "1");
		root.addAttribute("clustered", "0");
		root.addAttribute("numVDivLines", "10");
		root.addAttribute("anchorRadius", "2");
