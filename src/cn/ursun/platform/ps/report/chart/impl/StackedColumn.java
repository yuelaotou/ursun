/**
 * 文件名：StackedColumnBS.java
 *
 * 创建人：【周洋】 - 【zhouyang@neusoft.com】
 *
 * 创建时间：Dec 15, 2009 9:11:41 PM
 *
 * 版权所有：东软软件股份有限公司
 */
 ...
 * @version 1.0
 */
public class StackedColumn extends Chart {
	...
	public String getDataConversion()throws BizException{
		...
		root.addAttribute("startAngX", "10");
		root.addAttribute("endAngX", "18");
