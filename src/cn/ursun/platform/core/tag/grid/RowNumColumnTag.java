...
import cn.ursun.platform.core.tag.grid.component.RowNumComponent;
 ...
 * @version 1.0
 */
public final class RowNumColumnTag extends ColumnTagSupport {

	public RowNumColumnTag() {
		super();
	}

	public Component getBean(ValueStack valuestack, HttpServletRequest httpservletrequest,
			HttpServletResponse httpservletresponse) {
		return new RowNumComponent(valuestack);
	}
