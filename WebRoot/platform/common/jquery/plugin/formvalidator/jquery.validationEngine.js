...
jQuery.fn.validationEngine = function(settings) {
	...
	$(this+"[class^=validate]").not("[type=checkbox]").bind("blur", function(caller){loadValidation(this)})
	...
	var closePrompt = function(caller) {	// CLOSE PROMPT WHEN ERROR CORRECTED
		closingPrompt = $(caller).attr("name").replace(/\./g,"\\.");//修正，当name中包含"."，替换成转义字符
...
jQuery.fn.clearValidationPrompt = function() {	// CLOSE All PROMPT WHEN ERROR CORRECTED
