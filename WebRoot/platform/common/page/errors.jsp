	...
	<head>
		...
		<script>
			...
			function showdetail(){
				if(isShow ==0){
					isShow = 1
					document.getElementById("seedetail").innerText = '<s:text name="exception.hideExceptionStack"/>';
					document.getElementById("error_stack").style.display = 'block';
				}else{
					isShow = 0
					document.getElementById("seedetail").innerText = '<s:text name="exception.showExceptionStack"/>';
					document.getElementById("error_stack").style.display = 'none';
				}
			}
		</script>
	</head>
	<body>
	    ...
	    <div class="error_content">
	        ...
	        <div class="error_center1">
	        	...
	        	<div id="error_msg">
	        	<h3><s:text name="wee.error.msg"></s:text></h3>
	        	<ul id="error_msg_stack">
	        	<%
