...
<HTML>
	...
	<BODY>
		...
		<CENTER>
			...
			<n:chart chartType="PIE_3D" width="600" height="400" id="myChartId3"
				dataXML="<%=strXML%>" divName="chartdiv3" />

			<input type="button" value="Export My Chart"
				onclick="ExportMyChart()" />
		</CENTER>
	</BODY>
</HTML>
