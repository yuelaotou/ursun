...
<html>
	<head>
		...
		<n:base />
		<n:jquery components="autocomplete" />
...
function changeToMonths(){
	...
	<body>
		<h1 id="banner">jQuery Autocomplete Plugin Demo</h1>
		<div id="content">
			...
			<form autocomplete="off">
				<p>
					...
					<input type="button" value="Change Max Items"
						onclick="changeOptions();" />
					<input type="button" value="Change to Month Data"
						onclick="changeToMonths();" />
			...
			<p>
				<a href="#TB_inline?height=155&width=400&inlineId=modalWindow"
					class="thickbox">Click here for an autocomplete inside a
					thickbox window.</a> (this should work even if it is beyond the fold)
			</p>
